...
template <> constexpr inline auto PaintScene::qt_create_metaobjectdata<qt_meta_tag_ZN10PaintSceneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'linePointSignal'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'ellipsePointSignals'
...
void PaintScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->linePointSignal(); break;
        case 1: _t->ellipsePointSignals(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PaintScene::*)()>(_a, &PaintScene::linePointSignal, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PaintScene::*)()>(_a, &PaintScene::ellipsePointSignals, 1))
            return;
    }
}
...
// SIGNAL 0
void PaintScene::linePointSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void PaintScene::ellipsePointSignals()
{
